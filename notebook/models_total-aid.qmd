...
mfx_median_clean %>% 
  ...
  select(Probability, Treatment, direction, draw.nice, pct_change.nice) %>% 
  ...
  kbl(align = c("l", "l", "l", "c", "c"), escape = FALSE) %>% 
  ...
  column_spec(1, image = mfx_median_clean$png, width = "20%") %>% 
  column_spec(2, width = "31%") %>% 
  column_spec(3, width = "15%") %>% 
  column_spec(4, width = "17%") %>% 
  column_spec(5, width = "17%") %>% 
  footnote(symbol = tbl_notes, general_title = "", footnote_as_chunk = FALSE)
```
