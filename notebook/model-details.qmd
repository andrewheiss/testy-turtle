...
model_df_h2 <- tribble(
  ...
  "m_purpose_outcome_ccsi", "model_500", "Civil society index", "Outcome", "IPTW truncated at 500"
) %>% 
  mutate(model_nice = glue("<code>{model}${slot}</code>"))
...
computer_details <- "2021 M1 MacBook Pro with 10 cores and 32 GB of RAM, using Stan through brms through cmdstanr"
